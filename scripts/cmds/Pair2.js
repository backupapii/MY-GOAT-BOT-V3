...
module.exports = {
        ...
        onStart: async function ({ api, event, message, getLang }) {
                ...
                try {
                        ...
                        const pfp1 = `https://graph.facebook.com/${event.senderID}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`;
                        const pfp2 = `https://graph.facebook.com/${selectedMatch.id}/picture?width=512&height=512&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`;
                        const { data } = await axios.get(`https://api.popcat.xyz/ship?user1=${encodeURIComponent(pfp1)}&user2=${encodeURIComponent(pfp2)}`, { responseType: "arraybuffer" });
