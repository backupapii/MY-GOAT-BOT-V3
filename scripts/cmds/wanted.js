...
module.exports = {
  config: {
    ...
    longDescription: "Mention or reply someone to create wanted poster.",
    category: "fun",
    guide: { en: "{pn} @mention OR reply someone's message" }
  },
  ...
  onStart: async function ({ event, message, api, usersData }) {
    try {
      ...
      const photoUrl = `https://graph.facebook.com/${targetID}/picture?height=2048&width=2048&access_token=6628568379%7Cc1e620fa708a1d5696fb991c1bde5662`;
      ...
      ctx.fillText("Author: MD_SHAKIL", 350, 890);
