...
module.exports = {
        ...
        onLoad: async function () {
                if (!fs.existsSync(pathData)) {
                        const res = await axios.get('https://raw.githubusercontent.com/nasa/apod-api/master/docs/apod.json').catch(() => null);
if (!res) throw new Error("Could not fetch Hubble data");
